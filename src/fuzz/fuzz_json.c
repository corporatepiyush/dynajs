...
//
// NOTE: json_parse_value() guards recursion with js_check_stack_overflow.
// The memory limit below caps pathological allocations so they fail cleanly
// instead of being reported as OOM.
