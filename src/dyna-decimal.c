/* dyna:decimal -- exact decimal arithmetic, and an integral money type.
   ...
   decimal, Java's BigDecimal and SQL NUMERIC also speak. Full API: API.md. */
#include "dyna-nat.h"
...
static const JSCFunctionListEntry dyn_dec_proto[] = {
    JS_CFUNC_MAGIC_DEF("add", 2, dyn_dec_arith, OP_ADD),
    JS_CFUNC_MAGIC_DEF("sub", 2, dyn_dec_arith, OP_SUB),
    JS_CFUNC_MAGIC_DEF("mul", 2, dyn_dec_arith, OP_MUL),
    JS_CFUNC_MAGIC_DEF("div", 2, dyn_dec_arith, OP_DIV),
    JS_CFUNC_MAGIC_DEF("mod", 2, dyn_dec_arith, OP_MOD),
    JS_CFUNC_DEF("pow", 2, dyn_dec_pow),
    ...
    JS_CFUNC_MAGIC_DEF("round", 2, dyn_dec_round, 0),
    JS_CFUNC_MAGIC_DEF("toFixed", 2, dyn_dec_round, 1),
