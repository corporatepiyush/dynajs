                          ...
                          int argc, JSValueConst *argv)
{
    ...
    dyn_nanoid_fill(out, (size_t)size, DYN_NANOID_ALPHA,
                                   ...
                                   int argc, JSValueConst *argv)
{
    ...
    dyn_nanoid_fill(out, (size_t)size, alpha, n_alpha);
                        ...
                        int argc, JSValueConst *argv)
{
    ...
    dyn_uuid_entropy(raw + 6, 10);                /* 80 bits of randomness */
