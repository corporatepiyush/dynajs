 ...
 * from Math.random. v7 embeds a millisecond timestamp plus the RFC 9562 §6.2
                           ...
                           int argc, JSValueConst *argv)
{
    ...
    /* Monotonicity, RFC 9562 §6.2: one atomic word packs the millisecond and
