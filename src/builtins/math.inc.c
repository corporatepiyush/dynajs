...
static const JSCFunctionListEntry js_math_funcs[] = {
    ...
    JS_CFUNC_SPECIAL_DEF("abs", 1, f_f, js_sys_fabs ),
    JS_CFUNC_SPECIAL_DEF("floor", 1, f_f, js_sys_floor ),
    JS_CFUNC_SPECIAL_DEF("ceil", 1, f_f, js_sys_ceil ),
    JS_CFUNC_SPECIAL_DEF("round", 1, f_f, js_math_round ),
    JS_CFUNC_SPECIAL_DEF("sqrt", 1, f_f, js_sys_sqrt ),
    ...
    /* ES6 */
    JS_CFUNC_SPECIAL_DEF("trunc", 1, f_f, js_sys_trunc ),
