...
/* audit regressions: a THROWING option getter must propagate, not silently
   compute the code from the defaults (atSec=0 was the old, wrong behavior) */
{
  ...
  /* a throwing algo getter (string coercion) propagates too */
  caught = null;
  ...
  /* the engine is sane right after: defaults still work */
