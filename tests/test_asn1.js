...
{
    /* S7: JS_ToBigInt64 WRAPS modulo 2^64 -- encode must refuse, not wrap. */
    throws(() => ASN1.encode(ASN1.int(12345678901234567890n)),
           "a BigInt outside int64 refuses instead of wrapping negative");
