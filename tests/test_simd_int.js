...
{
    /* f32 cummax carries the running max past NaN (scalar `x[i] > acc` rule);
     * the vector scan used to splatter NaN over the rest of the array. */
    ...
    /* i32 cumsum wrap chain (exact, associative) */
