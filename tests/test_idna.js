...
/* differential pins (node-arbitrated): the pure codec rejects an empty
   basic part exactly like node's punycode.decode, U+1E9E maps to "ss" in
   BOTH transitional modes. The bare xn-- A-label validity is a URL-HOST
   pin (test_url_host.js), not an exported domainToASCII pin. */
