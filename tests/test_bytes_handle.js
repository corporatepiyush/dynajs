...
/* ---- the methods, and their agreement with the free functions ----------- */
{
     ...
     * adds the bulk pair readBytes/writeBytes to the same (read|write)
     * filter: 36 + 2 = 38. */
...
/* ---- Text --------------------------------------------------------------- */
{
    ...
    /*isValidUtf8 is an ACCESSOR (it reads like Bytes.isValidUtf8), so
     * it is missing from the typeof-function sweep above by design. */
    {
