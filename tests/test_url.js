...
/* C0 control bytes inside the authority must be refused, not carried into
   .host/.hostname where a Host header built from them would split (audit 8.4) */
throws(() => new URL("http://a\r\nb/"), "CR/LF in the authority is refused");
throws(() => new URL("http://a\tb/"), "a TAB in the authority is refused");
