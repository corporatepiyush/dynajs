 ...
 *     (2020-12 ): a subschema under an applicator keyword lives at
 ...
 *     JSON pointer (2020-12 with RFC 3986: %XX -> octet, then
...
/* spec-derived (2020-12 ): pointer segments chain through
...
/* spec-derived (2020-12 ): the pointer addresses the document, so
...
/* spec-derived (RFC 3986 ): a percent-encoded UTF-8 sequence decodes
