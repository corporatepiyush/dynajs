 ...
 * - Bytes.fill returns the underlying Uint8Array
...
// Bytes.fill returns the underlying Uint8Array (API contract: "not the handle")
{
    const b = new Bytes(new Uint8Array([1, 2, 3, 4]));
    const r = b.fill(9, 1, 3);
    assert(r === b.array, "Bytes.fill returns the underlying Uint8Array");
    assert(r instanceof Uint8Array, "Bytes.fill result is a Uint8Array");
