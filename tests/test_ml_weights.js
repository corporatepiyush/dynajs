...
/* ---- validation --------------------------------------------------------- */
{
    ...
    /*an UNKNOWN key is now refused, not ignored (the old contract
     * treated any object as a sampleWeight bag and silently dropped it). */
    let cc6 = null;
    ...
    assert(cc6 !== null && cc6 instanceof TypeError &&
        ...
        (cc6 && cc6.message) + ")");
    /* An options object with no sampleWeight at all is still fine. */
