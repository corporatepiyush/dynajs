...
try {
    ...
    /* ---------------- cwd / chDir round-trip ---------------- */
    {
        ...
        /* A NUL-bearing path is refused, not silently truncated to its prefix:
         * chdir() on the prefix of a path a JS-level validator approved is the
         * classic bypass ("...tmp\0/../../etc" would move to .../tmp). This is
         * setEnv's refuse-don't-truncate policy extended to the whole module. */
