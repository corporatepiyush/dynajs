...
/* a numeric token past INT_MAX wrapped atoi() negative and read argv[-1]
   (audit 3.1): it must render empty like any other missing index */
eq("{4294967295}".format("x"), "", "format overflow index -> empty, no argv[-1]");
eq("{2147483648}".format("x"), "", "format INT_MAX+1 index -> empty");
