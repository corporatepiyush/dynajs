 ...
 * ==================================================================== */
{
    ...
    /* Strict means STRICT: an impossible calendar date is refused, not
       normalized into the next month -- parseRFC3339 refuses "2021-02-30"
       and a strict parse that silently moves the day would make
       format(parse(format(t))) lie. (audit ws-time F1) */
