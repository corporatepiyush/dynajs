...
test("slice-neg", function () { assert_eq(String((function(){ return s.slice(-2); })()), "\u01c8", "slice-neg"); });
test("slice-mid", function () { assert_eq(String((function(){ return s.slice(1, 1); })()), "", "slice-mid"); });
test("slice-len", function () { assert_eq(String((function(){ return s.length; })()), "1", "slice-len"); });
