...
const ci = cpuInfo();
assert_eq(ci.threads, 10, "cpuInfo.threads vs sysctl hw.logicalcpu");
...
const mi = memInfo();
assert_eq(mi.total, 34359738368, "memInfo.total matches sysctl hw.memsize");
