// review kernel: 18-opcode dispatch switch over a top-level const object,
// 12M steps; prints a checksum so the work is not dead.
const OP = { HLT:0, PUS:1, POP:2, ADD:3, SUB:4, MUL:5, DIV:6, NEG:7, DUP:8,
             SWP:9, JMP:10, JZ:11, JPZ:12, LD:13, ST:14, PRT:15, NOP:16, EXT:17 };
