...
__EXP = null;
test("s4_redef_object.js per-engine behavior contract", function () {
    var __SRC = "// (e) second script redefines globalThis.Object entirely\nglobalThis.Object = function () { return {}; };\nObject.freeze = undefined;\nconsole.log(\"s2 sees OP via getOP:\", globalThis.getOP());\n";
    ...
    if (__ENGINE === 'dynajs') {
        ...
        assert_eq(__e && __e.message, "not a function", "dynajs error message");
    ...
    if (__ENGINE !== 'dynajs') {
        ...
        assert_eq(__e && __e.message, "globalThis.getOP is not a function", "node error message");
