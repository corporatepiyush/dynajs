...
print("=== semver ===");
{
    ...
    // sort: ascending, IN PLACE returning the same array (API contract)
    ...
    eq(outSorted === unsorted, true, "sort returns the same array");
    eq(JSON.stringify(unsorted), '["0.1.0","1.5.0","2.0.0"]', "sort sorted in place");
