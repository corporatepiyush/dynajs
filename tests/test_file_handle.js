...
/* ---- Regression (audit F3): star backtrack must not read past the subject.
 * A pattern whose tail fails AFTER the star consumed the whole subject used to
 * advance the resume point past the terminator; under ASan the old matcher
 * reported a heap-buffer-overflow on exactly these shapes. */
{
