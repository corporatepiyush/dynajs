...
def main(argv):
    ...
    # *.broken.js = negative-parse probes (broken by design: duplicate
    # bindings, missing modules). Their unused imports ARE the probe;
    # scanning them fails the gate on purpose-built fixtures.
    files = [f for f in files if not f.endswith('.broken.js')]
