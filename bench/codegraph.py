...
def expr_counts(body: str) -> dict[str, int]:
    ...
    return dict(
        ...
        # per-FUNCTION only. Asserts at file scope land in files.n_static_assert;
        # summing THIS across symbols gives 0 and silently filters nothing.
        ...
        for fn in sorted(filenames):
            ...
            cur = db.execute(
                ...
                (rel, os.path.dirname(rel) or ".", fn, ext,
                 ...
                 # case-sensitive "GENERATED" matched nothing: the banners here
                 # read "Generated by ..." and "do not edit", so every file
                 # scored 0 and the column was dead.
                 1 if ("unicode_gen" in fn or "-gen" in fn or
                       re.search(r'(?i)generated by|do not edit',
                                 text[:400])) else 0,
