...
declare module "dyna:net" {
    ...
    /** Connection-pool options shared by PgPool. */
    ...
    class PgPool {
        ...
        with<T>(fn: (client: PostgreSQL) => Promise<T>): Promise<T>;
        close(): Promise<void>;
    }
...
declare module "dyna:sys" {
     ...
     * the cap setNativeMemoryLimit() installed, 0 = uncapped. */
    function memoryUsage(): { mallocCount: number; mallocSize: number; objCount: number; peakRss: number; nativeSize: number; nativeLimit: number };
...
declare module "dyna:xml" {
    ...
    class SAXParser {
        ...
        constructor(handlers: SAXHandlers & { trim?: boolean; entities?: "decode" | "keep" });
